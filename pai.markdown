...
- 01: [Warmup(Bayes Linear Regression, Kernel Trick, Gaussian Process)](pai/warmup-1); Chapter 1.4, 2,3,4 of PAI, Chapter 7 to be added in future
- 02: [Active Learning; Chapter 8](pai/active-learning-2) of PAI
